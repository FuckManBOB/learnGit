...
;              in a local variable of the calling function. 
;
...
;********************************************************************************************************
;                                 TIMERA0  INTERRUPT VECTOR ENTRY
;
...
;********************************************************************************************************
            ...
            ORG     TIMERA0_VECTOR 
TA0_VEC     DW      TA0_ISR                 ; interrupt vector. Watchdog/Timer, Timer mode
