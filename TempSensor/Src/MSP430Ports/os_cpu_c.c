...
*                
* Compiler     : IAR System Embedded Workbench for TI MSP430 V5.50
*********************************************************************************************************
*/
...
{
    static u32 RTC_Tick;                        //当前TICK为125ms
    
    if((++RTC_Tick) % OS_TICKS_PER_SEC == 0)
    {
       LocalTime++;                            //秒计时
       CurTime = LocalTime;
       IsSendTime(LocalTime,2);                  //同步WdHandle
    }
